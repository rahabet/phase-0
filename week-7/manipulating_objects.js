...
//  I had trouble passing the terah.childeren section. I was not fully understood what was expected from me in the beginning but i googled a little bit and i got it.

// 2) How difficult was it to add and delete properties outside of the object itself?

// adding and deleting is not difficult at all since the instruction was pretty clear.

// 3)What did you learn about manipulating objects in this challenge?

//  I learned its needed to use square brackets to access the key, and curly brackets to access the value or key/value pair
