...
# => I think I have a better understanding on working with error messages now. I also struggled on the past exercise where I was expected to work with others code. I think now am getting better.
# What is still confusing to you about Ruby?
# => I struggle to put my ideas into coding and most of the time, i ended up searching on internet. I just wish to get it and do it by myslef which hopefully i will do soon.
# What are you going to study to get more prepared for Phase 1?
# => try to finish all the review exercises and go back to whatever we covered so far to get a solid understanding.