...
1) What did you learn about adding functions to objects?
    I can add a function to an object that calls another function outside of the object.
2)How did you iterate over nested arrays in JavaScript?
    we iterated over the array using a for loop
3)Were there any new methods you were able to incorporate? If so, what were they and how did they work?
    No I wasn't able to learn new methods for this challenge but I am more confident on using objects and functions.
*/
